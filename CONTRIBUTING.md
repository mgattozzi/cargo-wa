...
Want to help make `cargo-wasm` faster or to help expand the
feature set currently available? Then just follow these steps:
...
Documentation is an important part of any project and `cargo-wasm` is no
...
Have you encountered a problem with the binary? Please take a look at the
guidelines below for filing bugs:

### Filing Issues

If you're here then you've probably encountered an issue with `cargo-wasm`,
...
- What happened?
- What steps did you take with `cargo-wasm` to try to make that happen?
